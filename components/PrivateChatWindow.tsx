...
const PrivateChatWindow: React.FC<PrivateChatWindowProps> = ({ 
    ...
    return (
        <>
                ...
                `}>
                    <div className="flex items-center gap-2">
                        <div className="relative">
                            <img src={recipient.avatar ? pb.files.getUrl(recipient, recipient.avatar) : `https://ui-avatars.com/api/?name=${recipient.username}&background=random`} className="w-6 h-6 rounded-full object-cover" alt="" />
            ...
            {/* Lightbox Modal for Private Chat */}
            {viewingImage && (
